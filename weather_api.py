...
def current_weather(lat: float, lon: float) -> dict:
    """
    Функция отправляет запрос погоды на api.weather.yandex.ru для указанных координат
    """
    token = 'd7c9db5f-02e3-40c6-b662-d4e5f44131f7'  # Вставить ваш токен
    ...
    result = {
        ...
        'city': data['info']['tzinfo']['name'],  # Если используете Тариф «Погода на вашем сайте», то закомментируйте эту строку
